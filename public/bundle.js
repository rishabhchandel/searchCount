...
var _Ui = __webpack_require__(75);
...
var Flag = function (_React$Component) {
	...
	function Flag(props) {
		...
		return _possibleConstructorReturn(this, (Flag.__proto__ || Object.getPrototypeOf(Flag)).call(this, props));
	}
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"li",
					null,
					this.props.v ? this.props.v.word + " , count:" + this.props.v.count : ""
				)
			);
		}
	}]);
...
var _loop = __webpack_require__(74);
...
var Flag = function (_React$Component) {
	...
	_createClass(Flag, [{
		...
		value: function click(e) {
			...
			fetch("http://localhost:3000/key?name=" + name).then(function (res) {
				return res.json();
			}).then(function (res) {
				console.log("11", res);
				_this2.setState({
		...
		value: function search(e) {
			...
			if (name.length > 2) {
				fetch("http://localhost:3000/keys?name=" + name).then(function (res) {
					return res.json();
				}).then(function (res) {
					console.log("11", res);
					_this3.setState({
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"div",
					null,
					this.state.list && this.state.list.length ? this.state.list.map(function (v, i) {
						return _react2.default.createElement(_loop2.default, { key: i, v: v });
					}) : ""
				)
			);
		}
